...
export function PackagesButton() {
    ...
    return (
        <Link to="/packages" className="border border-black hover:scale-110 hover:duration-200 rounded-lg w-1/2 h-1/3
            lg:w-1/3 xl:w-1/4 lg:h-1/3 xl:h-1/2 flex flex-col items-center justify-center shadow-lg">
