...
export function DriverItem({ id, tba, weight, item, location, city, driverID, deleteDriver, editDriver }) {
    ...
    return (
        <li key={id} className="flex justify-between gap-x-6 py-5">
            ...
            <div className="flex flex-col items-center">
                ...
                <EditDriverModal tba={tba} weight={weight} item={item} location={location} city={city} driverID={driverID} editDriver={editDriver} DriverID={id}/>
            </div>
        </li>
