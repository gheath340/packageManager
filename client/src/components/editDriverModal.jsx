...
export function EditDriverModal({ id, driverID, city, editDriver, drivers }) {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="border border-gray-700 rounded-md hover:scale-110 
                                                     hover:duration-200 px-3 py-1 mt-2"
      >
        Edit
      </button>
      {modal && (
