    ...
    return (
        <li key={id} className="flex justify-between gap-x-6 py-5">
            ...
            <div className="flex flex-col lg:flex-row items-center">
                <button onClick={() => deletePackage(id)} className="border rounded-md hover:scale-110 hover:duration-200 p-1 w-full lg:w-2/3 lg:h-2/4">Delete</button>
                <button onClick={() => editPackage(id)} className="border rounded-md hover:scale-110 hover:duration-200 p-1 w-full lg:w-2/3 lg:h-2/4">Edit</button>
            </div>
        </li>
